...
const CATEGORY_META = {
  streetwear: {
    ...
    desc: 'Premium urban fashion for the bold generation',
    id: 'streetwear',
  },
  iit: {
    label: 'IIT Collection',
    desc: 'Exclusive designs for the campus elite',
    id: 'iit',
  },
};
    ...
    >
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '72px' }}>
          ...
          >
            Every piece engineered with 200 GSM premium fabric, bio-wash finish,
            and Gen-Z streetwear energy.
          </p>
        </div>
